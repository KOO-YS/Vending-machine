    ...
    private static void commandCustomer(Customer customer, int cmd) {
        switch (cmd) {
            ...
            case 2 :
                ...
                if(product != null)
                    System.out.println(product.toString()+" 물건을 받고, 자판기에 총 "+vendingMachine.getBalance()+"원이 남아 있습니다");
                break;
    ...
    private static void commandManager(Manager user, int cmd) throws IOException {
        ...
        switch (cmd) {
            case 1:
                ...
                user.stockUp(product, stock);
                System.out.println("상품 추가 완료 "+product.toString());
                break;
            case 2:
                printMachine();
                ...
                product = Product.builder().idx(idx).build();
                user.stockOut(product);
                break;
            ...
            case 3:
                ...
                product = Product.builder().idx(idx).build();
                user.updateProduct(product, price);
                break;
